...
public class DesignMenu extends World
{
    Option O[]={new Option(),new Option()};
    ButtonText B[]={new ButtonText("Acuratețe la măsurători"),new ButtonText("Timp de lucru")};
    
    ButtonText B2[]={new ButtonText("Acuratețe la măsurători"),new ButtonText("Timp de lucru")};
    ...
    Level L[]={new Level("MeasAcc.txt"),new Level("WkTime.txt")};
            ...
            public void Write0()
    {
         try
        {
            ...
            BufferedWriter output0=new BufferedWriter(new FileWriter("MeasAcc.txt"));
            output0.flush();
    ...
    public void Write1()
    {
         try
        {
            ...
            BufferedWriter output1=new BufferedWriter(new FileWriter("WkTime.txt"));
            output1.flush();
            ...
            public void decide(int i)
    {
        if(i==0) 
        {
            addObject(Number[ma],getWidth()/2-17,getHeight()/2+75);
        }
        if(i==1) 
        {
            addObject(Number[wt],getWidth()/2-17,getHeight()/2+75);
        }
    }
    
            public void decide2(int i)
    {
        if(i==0) removeObject(Number[ma]);
        if(i==1) removeObject(Number[wt]);;
    }
    ...
    public void act()
   {
       ...
       Read();
        ...
        for(i=0; i<2; i++)
        {
            ...
            else if(ma==2) addObject(CK[0],250,getHeight()/2-100);
            ...
            else if(wt==2) addObject(CK[1],250,getHeight()/2+100);
        }
    }
    else Locked();
}
